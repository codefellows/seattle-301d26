...
Article.prototype.toHtml = function() {
  ...
  // if(this.publishedOn) this.publishStatus = `published ${this.daysAgo} days ago`;
  // else this.publishStatus = '(draft)';
  ...
  //   author: this.author,
  //   // ...
  // }) // => template(this) returns a complete block of html content
  return template(this) // => template(this) returns a complete block of html content
};
